...
protected:
	...
	virtual void DoInit(const float &, BaseManager*,ISpatialDataProvider*); //script generated
	virtual void DoUpdate(const float &, BaseManager*,ISpatialDataProvider*); //script generated
};
