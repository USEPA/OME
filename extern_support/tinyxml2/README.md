...
tinyxml2.cpp and tinyxml2.h have been copied over from version 3.0.0
in accordance to tinyXML-2's zlib license. These files have not been
modified from their original form. This README has been modified to
omit information referring to files that have not been copied over
from the original version, such as project files or doxygen settings.
